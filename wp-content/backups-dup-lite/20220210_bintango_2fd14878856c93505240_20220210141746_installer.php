...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220210_bintango_2fd14878856c93505240_20220210141746_archive.zip';
	const ARCHIVE_SIZE		 = '52234366';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2fd1487-10141746';
    const SECONDARY_PACKAGE_HASH = '0dde13d-10141746';
	const VERSION			 = '1.4.4';
