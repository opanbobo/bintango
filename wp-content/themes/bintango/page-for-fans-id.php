...
<?php
/*
Template Name: for fans Page Indonesia
*/
?>
      ...
      <div class="container">
        ...
        $topSectionFans = get_field('top_section');  ?>
          <div class="col-md-7 text-white text-center mx-auto">
            ...
            <a class="btn btn__light btn--large text--tiger text-uppercase mt-5" href="https://fan.bintango.com/" target="_new">JELAJAHI MARKETPLACE/PASAR</a>
          </div>          
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mt-5">
            <h1 class="text-center">Mengapa mereka 💖 1-on-1 Video call </h1>
      ...
      <div class="container">
        ...
        $efs = get_field('end_fans_section');  ?>    
          <div class="col-md-4 offset-md-1 align-self-center text-center text-md-left order-md-2">
            ...
            <a href="https://bintango.com/" class="btn btn__tiger mb-5" target="_new">JELAJAHI PASAR/MARKETPLACE</a>
          </div>    
