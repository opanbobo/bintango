      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            ...
            <p>Download the application to run your business as Creator. Engage with Brands and Grow your Fans.</p>
            <div class="row mb-4">
              <div class="col-6">
          ...
          <div class="col-md-8 offset-md-1">
            <div class="row">
              <div class="col-md-3 col-6">
                <h4 class="mb-2 mb-md-4">Information</h4>
                <ul class="nav flex-column">
                  <!-- <li class="nav-item"><a class="nav-link" href="<?php echo get_page_link( get_page_by_title( 'about us' ) ); ?>">About us</a></li> -->
                  <li class="nav-item"><a class="nav-link" href="https://fan.bintango.com/condition">Terms & Condition</a></li>
                  <li class="nav-item"><a class="nav-link" href="https://fan.bintango.com/privacy">Privacy Policy</a></li>
                </ul>
              </div>
              <div class="col-md-3 col-6">
                <h4 class="mb-2 mb-md-4">BintanGO</h4>
                <ul class="nav flex-column">
                  <li class="nav-item"><a class="nav-link" href="<?php echo get_page_link( get_page_by_title( 'for creators' ) ); ?>">For Creators</a></li>
                  <li class="nav-item"><a class="nav-link" href="<?php echo get_page_link( get_page_by_title( 'for business' ) ); ?>">For Business</a></li>
                  <li class="nav-item"><a class="nav-link" href="<?php echo get_page_link( get_page_by_title( 'for fans' ) ); ?>">For Fans</a></li>
                  <li class="nav-item"><a class="nav-link" href="https://www.techinasia.com/companies/bintango">Career</a></li>
