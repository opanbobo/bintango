...
<?php
/*
Template Name: for business Page Indonesia
*/
?>
      ...
      <div class="container">
        ...
        $welcomeFB = get_field('top_section');  ?>
          <div class="col-md-6">
            ...
            <a class="btn btn__light btn--large text--tiger text-uppercase" href="https://api.whatsapp.com/send/?phone=6281280777870&text=Halo+saya+mengunjungi+web+BintanGO%2C+dan+ingin+berkolaborasi+dengan+Creator+dong%2C+nama+brand+saya+&app_absent=0" target="_new">Berkolaborasi Dengan Kami Sekarang</a>
          </div> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <h1>Kembangkan Bisnis Anda dengan Pemasaran yang Didukung Oleh Para Kreator 💪</h1>
            <p>Dipercaya oleh 500+ Kreator </p>
          </div>          
        </div>
      </div>
    ...
    <section class="businessclient">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center mb-5">
            <h1>Agensi dan Brand yang 💖 BintanGO Creators</h1>
          </div>
        </div>
        <div class="row">
        <?php 
        ...
        <div class="row">
          <div class="col-md-12 text-center my-5">
            ...
            <div class="hitus hitus-text">
              ...
              <a class="btn btn--large btn__tiger text-uppercase mt-5" href="https://api.whatsapp.com/send/?phone=6281280777870&text=Halo+saya+mengunjungi+web+BintanGO%2C+dan+ingin+berkolaborasi+dengan+Creator+dong%2C+nama+brand+saya+&app_absent=0" target="_new">Kirimkan Kami Pesan</a>
            </div>
