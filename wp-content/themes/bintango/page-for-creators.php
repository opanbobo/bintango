...
<?php
/*
Template Name: for creators Page
*/
?>
    ...
    <section class="testimonial">
      ...
      <div class="container-fluid px-0">
        ...
        <div class="col-12 text-center mt-5">
          <a href="<?php echo get_page_link( get_page_by_title( 'for business' ) ); ?>" class="btn btn--mid btn__tiger">JOIN THE COMMUNITY</a>
        </div>
      </div>
    </section>
            ...
            <div class="row">              
              <div class="col-md-9 order-md-2">
                <div class="tab-content" id="v-pills-tabContent">
                  ...
                  $href = 1;
                  $control = 1;
                  $listScroll = get_field('column_list_scroll', 572);
                  if( $listScroll ) {
