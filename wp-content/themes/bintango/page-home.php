      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-10 mx-auto text-center">
            ...
            <a href="#BuiltForCreator" class="btn btn__medium btn--light text--tiger mt-5 mb-2">Discover Now</a>
          </div>
    ...
    <section id="BuiltForCreator" class="forcreator">
      ...
      <div class="container">
        ...
        <div class="col-12 text-center mt-5">
          <a href="<?php echo get_page_link( get_page_by_title( 'for creators' ) ); ?>" class="btn btn--large btn__tiger">JOIN THE COMMUNITY</a>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7 align-self-center">
            ...
            <a href="https://fan.bintango.com/" class="btn btn--large btn__tiger" target="_new">EXPLORE MARKETPLACE</a>
      ...
      <div class="container">
        ...
        ?>
          ...
          <div class="col-12 text-center">
            <a href="<?php echo get_page_link( get_page_by_title( 'for business' ) ); ?>" class="btn btn--large btn__tiger">COLLABORATE WITH US</a>
          </div>
        </div>
      </div>
    </section>
